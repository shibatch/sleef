...
apt-get -qq update
apt-get install -y git cmake clang-5.0 gcc-powerpc64le-linux-gnu libc6-ppc64el-cross libc6:ppc64el libmpfr-dev:ppc64el libgomp1:ppc64el libmpfr-dev binfmt-support qemu qemu-user-static libfftw3-dev:ppc64el
