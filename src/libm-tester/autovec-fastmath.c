...
// CHECK: _ZGVdN4v_Sleef_log_u35
}

void testlogf() {
// CHECK_LABEL: testlogf
  for(int i=0;i<N;i++) e[i] = logf(f[i]);
// CHECK: _ZGVdN8v_Sleef_logf_u35
}
