...
#define SUBST_IF_EXT1(funcExt1) if (Sleef_cpuSupportsExt_internal(tryEXT1, &cache_avx2)) p = funcExt1;
#endif

#ifdef ENABLE_VSX3
static int cache_vsx3 = -1;
static void tryEXT1() { sleef_cpuid_EXT = Sleef_sinq2_u10vsx3(sleef_cpuid_EXT); }
#define SUBST_IF_EXT1(funcExt1) if (Sleef_cpuSupportsExt_internal(tryEXT1, &cache_vsx3)) p = funcExt1;
#endif

#ifdef ENABLE_VXE2
static int cache_vxe2 = -1;
static void tryEXT1() { sleef_cpuid_EXT = Sleef_sinq2_u10vxe2(sleef_cpuid_EXT); }
#define SUBST_IF_EXT1(funcExt1) if (Sleef_cpuSupportsExt_internal(tryEXT1, &cache_vxe2)) p = funcExt1;
#endif
