...
EXPORT CONST Sleef_quad2 xsincospiq_u05(Sleef_quad d) {
  ...
  u = +0.1528321016188828732764080161368244291e-27f128;
  u = mlaq(u, s, -0.1494741498689376415859233754050616110e-24f128);
  u = mlaq(u, s, +0.1226149947504428931621181953791777769e-21f128);
  u = mlaq(u, s, -0.8348589834426964519785265770009675533e-19f128);
  u = mlaq(u, s, +0.4628704628834415551415078707261146069e-16f128);
  u = mlaq(u, s, -0.2041026339664143925641158896030605061e-13f128);
  u = mlaq(u, s, +0.6948453273886629408492386065037620114e-11f128);
  u = mlaq(u, s, -0.1757247673443401045145682042627557066e-8f128);
  u = mlaq(u, s, +0.3133616890378121520950407496603902388e-6f128);
  u = mlaq(u, s, -0.3657620418217725078660518698299784909e-4f128);
  u = mlaq(u, s, +0.2490394570192720160015798421577395304e-2f128);
  x = dqadd2_q2_q_q2(u * s, dq(-0.08074551218828078170696957048724322192457f128, 5.959584458773288360696286320980429277618e-36));
  x = dqadd2_q2_q2_q2(dqmul_q2_q2_q2(s2, x), dq(0.7853981633974483096156608458198756993698f128, 2.167745574452451779709844565881105067311e-35f128));
  ...
  u = -0.4616472554003168470361503708527464705e-29f128;
  u = mlaq(u, s, +0.4891528531228245577148587028696897180e-26f128);
  u = mlaq(u, s, -0.4377345071482935585011339656701961637e-23f128);
  u = mlaq(u, s, +0.3278483561449753435303463083506802784e-20f128);
  u = mlaq(u, s, -0.2019653396886554861865456720993185772e-17f128);
  u = mlaq(u, s, +0.1001886461636271957275884859852184250e-14f128);
  u = mlaq(u, s, -0.3898073171259675439843028673969857173e-12f128);
  u = mlaq(u, s, +0.1150115912797405152263176921581706121e-9f128);
  u = mlaq(u, s, -0.2461136950494199754009084018126527316e-7f128);
  u = mlaq(u, s, +0.3590860448591510079069203991167071234e-5f128);
  u = mlaq(u, s, -0.3259918869273900136414318317506198622e-3f128);
  x = dqadd2_q2_q_q2(u * s, dq(0.01585434424381550085228521039855226376329f128, 6.529088663284413499535484912972485728198e-38f128));
  x = dqadd2_q2_q2_q2(dqmul_q2_q2_q2(s2, x), dq(-0.308425137534042456838577843746129712906f128, -1.006808646313642786855469666154064243572e-35f128));
...
EXPORT CONST Sleef_quad2 xsincospiq_u35(Sleef_quad d) {
  ...
  u = -0.1485963032785725729464918728185622156e-24f128;
  u = mlaq(u, s, +0.1226127943866088943202201676879490635e-21f128);
  u = mlaq(u, s, -0.8348589518463078609690110857435995326e-19f128);
  u = mlaq(u, s, +0.4628704628547538824855302470312741438e-16f128);
  u = mlaq(u, s, -0.2041026339663972432248777826778586936e-13f128);
  u = mlaq(u, s, +0.6948453273886628726907826757576187848e-11f128);
  u = mlaq(u, s, -0.1757247673443401044967978719804318982e-8f128);
  u = mlaq(u, s, +0.3133616890378121520950114757196589206e-6f128);
  u = mlaq(u, s, -0.3657620418217725078660518414453815240e-4f128);
  u = mlaq(u, s, +0.2490394570192720160015798421435124000e-2f128);
  u = mlaq(u, s, -0.8074551218828078170696957048724041729e-1f128);
  u = mlaq(u, s, +0.7853981633974483096156608458198756994e+0f128);
  
  r.x = u * t;

  //

  u = +0.4862670988511544771355006256522366302e-26f128;
  u = mlaq(u, s, -0.4377265452147065611484052550741141029e-23f128);
  u = mlaq(u, s, +0.3278483433857326331665386021267750285e-20f128);
  u = mlaq(u, s, -0.2019653396755055912482006994709659430e-17f128);
  u = mlaq(u, s, +0.1001886461636180795663169552615123249e-14f128);
  u = mlaq(u, s, -0.3898073171259675007871885150022866077e-12f128);
  u = mlaq(u, s, +0.1150115912797405152123832255915284811e-9f128);
  u = mlaq(u, s, -0.2461136950494199754008784937314856168e-7f128);
  u = mlaq(u, s, +0.3590860448591510079069203583263258862e-5f128);
  u = mlaq(u, s, -0.3259918869273900136414318317180623832e-3f128);
  u = mlaq(u, s, +0.1585434424381550085228521039855096075e-1f128);
  u = mlaq(u, s, -0.3084251375340424568385778437461297129e+0f128);
  u = mlaq(u, s, 1.0f128);
...
int main(int argc, char **argv) {
  Sleef_quad a = -8.3998726984803832684266802333309369056312711821029e-09f128;
  Sleef_quad2 q = xsincospiq_u05(a);
  printf("    "); printf128(q.x); printf("\n");

  /*
  printf128(0.1f128); printf("\n");
  Sleef_quad2 q2 = dqmul_q2_q_q(0.1f128, 0.1f128);
  printf128(q2.x); printf("\n");
  printf128(q2.y); printf("\n");
  */
  /*
  printf("%s\n", toBCq(0.1f128));
  printf("%s\n", toBCq(upperq(0.1f128)));
  printf("%s\n", toBCq(0.1f128-upperq(0.1f128)));
  Sleef_quad2 q2 = dqmul_q2_q_q(0.1f128, 0.1f128);
  printf("%s + ", toBCq(q2.x));
  printf("%s\n", toBCq(q2.y));
  */
