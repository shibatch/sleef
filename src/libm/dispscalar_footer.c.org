...
#define DALIAS_d2_d(DFUNC, SFUNC) EXPORT CONST double2 DFUNC(double d) { return SFUNC (d); }
...
#define DALIAS_d_d_i(DFUNC, SFUNC) EXPORT CONST double DFUNC(double x, int i) { return SFUNC (x, y, z); }
...
#define DALIAS_f_f_i(DFUNC, SFUNC) EXPORT CONST float DFUNC(float x, int i) { return SFUNC (x, y); }
#endif
