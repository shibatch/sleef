...
#define POLY2(x, c1, c0) mla(x, c1, c0)
#define POLY3(x, x2, c2, c1, c0) mla(x2, c2, mla(x, c1, c0))
#define POLY4(x, x2, c3, c2, c1, c0) mla(x2, mla(x, c3, c2), mla(x, c1, c0))
#define POLY5(x, x2, x4, c4, c3, c2, c1, c0) mla(x4, c4, POLY4(x, x2, c3, c2, c1, c0))
...
#define POLY9(x, x2, x4, x8, c8, c7, c6, c5, c4, c3, c2, c1, c0)\
  mla(x8, c8, POLY8(x, x2, x4, c7, c6, c5, c4, c3, c2, c1, c0))
...
#define POLY17(x, x2, x4, x8, x16, d0, cf, ce, cd, cc, cb, ca, c9, c8, c7, c6, c5, c4, c3, c2, c1, c0)\
  mla(x16, d0, POLY16(x, x2, x4, x8, cf, ce, cd, cc, cb, ca, c9, c8, c7, c6, c5, c4, c3, c2, c1, c0))
...
EXPORT CONST double xtan_u1(double d) {
  ...
  double s2 = s.x * s.x, s4 = s2 * s2, s8 = s4 * s4, s16 = s8 * s8;
  x = ddmul_d2_d2_d2(t, ddadd_d2_d_d2(1, ddmul_d2_d2_d(s, 0.333333333333334980164153)));
  ...
  x = ddadd_d2_d2_d2(x, ddmul_d2_d2_d(ddmul_d2_d2_d(ddsqu_d2_d2(s), t.x), u));
...
static INLINE CONST Sleef_double2 expk2(Sleef_double2 d) {
  ...
  Sleef_double2 s2 = ddsqu_d2_d2(s), s4 = ddsqu_d2_d2(s2);
  double s8 = s4.x * s4.x;
  ...
  t = ddadd_d2_d_d2(0.5, ddmul_d2_d2_d(s, +0.1666666666666666574e+0));
  t = ddadd_d2_d_d2(1.0, ddmul_d2_d2_d2(t, s));
  t = ddadd_d2_d_d2(1.0, ddmul_d2_d2_d2(t, s));
  t = ddadd_d2_d2_d2(t, ddmul_d2_d2_d(s4, u));
