...
EXPORT CONST double xexp10(double d) {
  ...
  u = +0.2411463498334268736e-3;
  u = mla(u, s, +0.1157488415217188243e-2);
  u = mla(u, s, +0.5013975546789721516e-2);
  u = mla(u, s, +0.1959762320720533774e-1);
  u = mla(u, s, +0.6808936399446775811e-1);
  u = mla(u, s, +0.2069958494722674014e+0);
  u = mla(u, s, +0.5393829292058549552e+0);
  u = mla(u, s, +0.1171255148908542543e+1);
