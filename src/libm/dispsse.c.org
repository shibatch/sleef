...
#define VECALIAS_vf_vf_vi(fptype, itype, funcNameS, funcName, veclen) \
  EXPORT CONST VECTOR_CC fptype _ZGVbN ## veclen ## vv_ ## funcNameS(fptype, itype) __attribute__((alias(stringify(funcName))));
#else
#define VECALIAS_vf_vf_vi(fptype, itype, funcNameS, funcName, veclen)
#endif
...
#define VECALIAS_vi_vf(fptype, itype, funcNameS, funcName, veclen) \
  EXPORT CONST VECTOR_CC itype _ZGVbN ## veclen ## v_ ## funcNameS(fptype) __attribute__((alias(stringify(funcName))));
#else
#define VECALIAS_vi_vf(fptype, itype, funcNameS, funcName, veclen)
#endif
