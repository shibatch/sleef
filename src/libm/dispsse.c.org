...
#define VECALIAS_vf_vf(fptype, funcNameS, funcName, veclen) \
  fptype _ZGVbN ## veclen ## v_ ## funcNameS(fptype) __attribute__((alias(stringify(funcName))));
#else
#define VECALIAS_vf_vf(fptype, funcNameS, funcName, veclen)
#endif

#define DISPATCH_vf_vf(fptype, fptype2, itype, veclen, funcNameS, funcName, pfn, dfn, funcsse2, funcsse4, funcavx2) \
...
#define VECALIAS_vf_vf_vf(fptype, funcNameS, funcName, veclen) \
  fptype _ZGVbN ## veclen ## vv_ ## funcNameS(fptype, fptype) __attribute__((alias(stringify(funcName))));
#else
#define VECALIAS_vf_vf_vf(fptype, funcNameS, funcName, veclen)
#endif

#define DISPATCH_vf_vf_vf(fptype, fptype2, itype, veclen, funcNameS, funcName, pfn, dfn, funcsse2, funcsse4, funcavx2) \
...
#define DISPATCH_vf2_vf(fptype, fptype2, itype, veclen, funcNameS, funcName, pfn, dfn, funcsse2, funcsse4, funcavx2) \
...
#define VECALIAS_vf_vf_vi(fptype, itype, funcNameS, funcName, veclen) \
  fptype _ZGVbN ## veclen ## vv_ ## funcNameS(fptype, itype) __attribute__((alias(stringify(funcName))));
#else
#define VECALIAS_vf_vf_vi(fptype, itype, funcNameS, funcName, veclen)
#endif

#define DISPATCH_vf_vf_vi(fptype, fptype2, itype, veclen, funcNameS, funcName, pfn, dfn, funcsse2, funcsse4, funcavx2) \
...
#define VECALIAS_vi_vf(fptype, itype, funcNameS, funcName, veclen) \
  itype _ZGVbN ## veclen ## v_ ## funcNameS(fptype) __attribute__((alias(stringify(funcName))));
#else
#define VECALIAS_vi_vf(fptype, itype, funcNameS, funcName, veclen)
#endif

#define DISPATCH_vi_vf(fptype, fptype2, itype, veclen, funcNameS, funcName, pfn, dfn, funcsse2, funcsse4, funcavx2) \
...
#define VECALIAS_vf_vf_vf_vf(fptype, funcNameS, funcName, veclen) \
  fptype _ZGVbN ## veclen ## vvv_ ## funcNameS(fptype, fptype, fptype) __attribute__((alias(stringify(funcName))));
#else
#define VECALIAS_vf_vf_vf_vf(fptype, funcNameS, funcName, veclen)
#endif

#define DISPATCH_vf_vf_vf_vf(fptype, fptype2, itype, veclen, funcNameS, funcName, pfn, dfn, funcsse2, funcsse4, funcavx2) \
...
#define DISPATCH_i_i(fptype, fptype2, itype, veclen, funcNameS, funcName, pfn, dfn, funcsse2, funcsse4, funcavx2) \
...
#define DISPATCH_p_i(fptype, fptype2, itype, veclen, funcNameS, funcName, pfn, dfn, funcsse2, funcsse4, funcavx2) \
