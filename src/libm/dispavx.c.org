...
#define VECALIAS_vf_vf_vi(fptype, itype, funcNameS, funcName, veclen)	\
  EXPORT CONST VECTOR_CC fptype _ZGVcN ## veclen ## vv_ ## funcNameS(fptype, itype) __attribute__((alias(stringify(funcName)))); \
  EXPORT CONST VECTOR_CC fptype _ZGVdN ## veclen ## vv_ ## funcNameS(fptype, itype) __attribute__((alias(stringify(funcName))));
#else
#define VECALIAS_vf_vf_vi(fptype, itype, funcNameS, funcName, veclen)
#endif
...
#define VECALIAS_vi_vf(fptype, itype, funcNameS, funcName, veclen)	\
  EXPORT CONST VECTOR_CC itype _ZGVcN ## veclen ## v_ ## funcNameS(fptype) __attribute__((alias(stringify(funcName)))); \
  EXPORT CONST VECTOR_CC itype _ZGVdN ## veclen ## v_ ## funcNameS(fptype) __attribute__((alias(stringify(funcName))));
#else
#define VECALIAS_vi_vf(fptype, itype, funcNameS, funcName, veclen)
#endif
