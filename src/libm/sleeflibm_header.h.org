...
#if defined(__VX__)
#include <vecintrin.h>
typedef __attribute__((vector_size(16))) double  SLEEF_VECTOR_DOUBLE;
typedef __attribute__((vector_size(16))) float   SLEEF_VECTOR_FLOAT;
typedef __attribute__((vector_size(16))) int32_t SLEEF_VECTOR_INT;
#endif
