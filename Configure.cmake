...
if (SLEEF_ENABLE_TLFLOAT)
  ...
  if (EXISTS "${TLFLOAT_SOURCE_DIR}/CMakeLists.txt")
    ...
    link_directories(BEFORE "${TLFLOAT_INSTALL_DIR}/${CMAKE_INSTALL_LIBDIR}")
...
elseif(CMAKE_GENERATOR_PLATFORM)
  set(SLEEF_TARGET_PROCESSOR "${CMAKE_GENERATOR_PLATFORM}")
endif()
...
elseif(MSVC)
  ...
  elseif(SLEEF_ARCH_AARCH64)
    set(FLAGS_ENABLE_ADVSIMD /D__ARM_NEON)
  endif()
