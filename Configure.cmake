...
if(CMAKE_C_COMPILER_ID MATCHES "(GNU|Clang)")
  ...
  if(CMAKE_C_COMPILER_ID MATCHES "GNU")
    ...
    if (ENABLE_LTO AND NOT BUILD_SHARED_LIBS)
      if (NOT GCC_AR_COMMAND)
	find_program(GCC_AR_COMMAND "gcc-ar")
      endif()
      if (GCC_AR_COMMAND)
	SET(CMAKE_AR ${GCC_AR_COMMAND})
	SET(CMAKE_C_ARCHIVE_CREATE "<CMAKE_AR> qcs <TARGET> <LINK_FLAGS> <OBJECTS>")
	SET(CMAKE_C_ARCHIVE_FINISH "true")
	message(STATUS "Building static libs with LTO")
	string(CONCAT FLAGS_OTHERS "-flto")
      endif(GCC_AR_COMMAND)
    endif(ENABLE_LTO AND NOT BUILD_SHARED_LIBS)
